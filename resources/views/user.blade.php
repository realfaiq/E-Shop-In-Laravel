        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-primary ml-3 button" href="{{route('index')}}">Sign Out</a>
                    </li>
        ...
        <div class="container">
            <div class="m-0 d-flex">
                <div class="Clothes text-white mr-2" id="cat-active">
                    <a href="{{route('user')}}" id="dect" class="text-white"><i class="fas fa-tshirt"></i> Clothes</a>
                </div>

                <div class="Tech text-white mr-2" id="cat">
                    <a href="{{route('user')}}" id="dect" class="text-white"><i class="fas fa-laptop"></i> Technology</a>
                </div>

                <div class="Tech text-white mr-2" id="cat">
                    <a href="{{route('user')}}" id="dect" class="text-white"><i class="fas fa-paw"></i> Pets</a>
                </div>

                <div class="Tech text-white mr-2" id="cat">
                    <a href="{{route('user')}}" class="text-white" id="dect"><i class="fas fa-lemon"></i> Vegetables</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="container mt-5">
        <div class="d-md-flex container mt-5 text-muted">
            ...
            <div class="categories p-2 mr-5">
                <h3>Categories</h3>
                <ul class="p-0 m-0">
                    <li class="list-item"><a class="text-muted" href="{{route('user')}}">Clothes</a></li>
                    <li class="list-item"><a class="text-muted" href="{{route('user')}}">Technology</a></li>
                    <li class="list-item"><a class="text-muted" href="{{route('user')}}">Pets</a></li>
                    <li class="list-item"><a class="text-muted" href="{{route('user')}}">Vegetables</a></li>
                </ul>
            </div>
            ...
            <div class="quicklinks p-2">
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="list-item"><a class="text-muted" href="{{route('user')}}">E-Shop</a></li>
                </ul>
            </div>
