...
<body>
        ...
        <div class="container">
            <div class="m-0 d-flex">
                <div class="Clothes text-white mr-2" id="cat">
                    <a href="<?php echo e(route('index')); ?>" id="dect" class="text-white"><i class="fas fa-tshirt"></i> Clothes</a>
                </div>

                <div class="Tech text-white mr-2" id="cat">
                    <a href="<?php echo e(route('technology')); ?>" id="dect" class="text-white"><i class="fas fa-laptop"></i> Technology</a>
                </div>

                <div class="Tech text-white mr-2" id="cat-active">
                    <a href="<?php echo e(route('pets')); ?>" id="dect" class="text-white"><i class="fas fa-paw"></i> Pets</a>
                </div>

                <div class="Tech text-white mr-2" id="cat">
                    <a href="<?php echo e(route('vegetables')); ?>" class="text-white" id="dect"><i class="fas fa-lemon"></i> Vegetables</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-md-flex mt-4 container">
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Pet-1.jpg" alt="" height="40%" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Persian Cat</h5>
                <p class="card-text">A nice and a Playful Cat you wouldn't regret Buying</p>
                <a href="#" class="btn btn-primary">$45 Add to Cart</a>
            </div>
        </div>

        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Pet-2.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Persian Street Cat</h5>
                <p class="card-text">A nice and a Playful Cat you wouldn't regret Buying</p>
        ...
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Pet-3.jpg" alt="" height="40%" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Persian Cat</h5>
                <p class="card-text">A nice and a Playful Cat you wouldn't regret Buying</p>
        ...
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Pet-4.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Russian Cat</h5>
                <p class="card-text">A nice and a Playful Cat you wouldn't regret Buying</p>
    ...
    <div class="d-md-flex mt-5 container">
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Dog-1.jpg" alt="" height="40%" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Pet Dog</h5>
                <p class="card-text">A nice and a Playful Dog you wouldn't regret Buying</p>
                <a href="#" class="btn btn-primary">$63 Add to Cart</a>
            </div>
        </div>

        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Dog-2.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Pet Dog</h5>
                <p class="card-text">A nice and a Playful Dog you wouldn't regret Buying</p>
        ...
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Dog-3.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Pet Dog</h5>
                <p class="card-text">A nice and a Playful Dog you wouldn't regret Buying</p>
        ...
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Dog-4.jpg" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Pet Dog</h5>
                <p class="card-text">A nice and a Playful Dog you wouldn't regret Buying</p>
    ...
    <div class="d-md-flex mt-5 container">
        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Horse-1.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">White Horse</h5>
                <p class="card-text">An Attractive Gorgeous looking White Horse you have to check out</p>
                <a href="#" class="btn btn-primary">$85 Add to Cart</a>
            </div>
        </div>

        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Horse-2.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Brown Horse</h5>
                <p class="card-text">An Attractive Gorgeous looking Brown Horse you have to check out</p>
                <a href="#" class="btn btn-primary">$80 Add to Cart</a>
            </div>
        </div>

        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Horse-3.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">Black Horse</h5>
                <p class="card-text">An Attractive Gorgeous looking Black Horse you have to check out</p>
                <a href="#" class="btn btn-primary">$79 Add to Cart</a>
            </div>
        </div>

        <div class="card mr-5" style="width: 18rem">
            <img src="./img/Pets/Horse-4.jpg" height="40%" alt="" class="card-img-top" alt="Card Img Top">
            <div class="card-body">
                <h5 class="card-title">White Horse</h5>
                <p class="card-text">An Attractive Gorgeous looking White Horse you have to check out</p>
    ...
    <footer class="container mt-5">
        <div class="d-md-flex container mt-5 text-muted">
            ...
            <div class="categories p-2 mr-5">
                <h3>Categories</h3>
                <ul class="p-0 m-0">
                    <li class="list-item"><a class="text-muted" href="<?php echo e(route('index')); ?>">Clothes</a></li>
                    <li class="list-item"><a class="text-muted" href="<?php echo e(route('technology')); ?>">Technology</a></li>
                    <li class="list-item"><a class="text-muted" href="<?php echo e(route('pets')); ?>">Pets</a></li>
                    <li class="list-item"><a class="text-muted" href="<?php echo e(route('vegetables')); ?>">Vegetables</a></li>
                </ul>
            </div>
            ...
            <div class="quicklinks p-2">
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="list-item"><a class="text-muted" href="<?php echo e(route('index')); ?>">E-Shop</a></li>
                </ul>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-projects\E-Shop\laravel\resources\views/pets.blade.php ENDPATH**/ ?>