    ...
    <footer class="container mt-5">
        <div class="d-md-flex container mt-5 text-muted">
            ...
            <div class="quicklinks p-2">
                <h3>Quick Links</h3>
                <ul class="p-0 m-0">
                    <li class="list-item"><a class="text-muted" href="">Contact Us</a></li>
                    <li class="list-item"><a class="text-muted" href="">Privacy Policy</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-projects\E-Shop\laravel\resources\views/index.blade.php ENDPATH**/ ?>